...
@section('content')
    ...
    <h1><b>Data Surat</b></h1>
    <br>
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                    <div class="col-md-6 mb-2">
                        <a href="{{ route('surat.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Tambah</a>
                ...
                @foreach ($letters as $letter)
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('surat.show', $letter['id']) }}" class="btn btn-dark">Lihat</a>
                                <a href="{{ route('surat.edit', $letter['id']) }}" class="btn btn-warning"><i class="bx bx-edit-alt"></i></a>
